...
const sequelize = new Sequelize(
  ...
  process.env.DB_PASSWORD || 'postgres',
  {
    ...
    logging: false,
    define: {
      underscored: true, // Преобразует camelCase в snake_case
    },
  }
);
...
db.Goods = require('./goods.model.js')(sequelize, DataTypes);

// Если есть старые модели — оставляем их
try {
db.GoodsGroups = require('./goods-group.model.js')(sequelize, DataTypes);
